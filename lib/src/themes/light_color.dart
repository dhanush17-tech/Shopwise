...
class LightColor {
  static const Color background = Color(4281810250); // Color(0XFFFFFFFF);

  static const Color titleTextColor =
      const Color(0xFF4985FD); // const Color(0xff1d2635);
  static const Color subTitleTextColor =
      Color.fromARGB(255, 226, 222, 222); //const Color(0xff797878);

  static const Color skyBlue = Color(0xff2890c8);
  static const Color lightBlue = Color(0xff5c3dff);

  static const Color orange = Colors.white; // Color(0xffE65829);
